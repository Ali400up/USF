...
const SECTION_MAP = {
  ...
  assistant: {
    id: "assistant",
    path: "/assistant",
    title: "مساعد ملتقى الطالب الجامعي الذكي | جامعة العلوم والتكنولوجيا",
    description: "اسأل مساعد ملتقى الطالب الجامعي الذكي عن التعريف بالملتقى وأهدافه ولجانه وشروط الانضمام والأنشطة والدورات والمبادرات والخدمات والروابط المعتمدة لطلاب جامعة العلوم والتكنولوجيا بصنعاء.",
    keywords: "مساعد ملتقى الطالب الجامعي, الدردشة الذكية, مساعد الطلاب, جامعة العلوم والتكنولوجيا صنعاء, أسئلة الملتقى, لجان الملتقى, الانضمام إلى الملتقى, خدمات الطلاب"
  },
  issues: {
    id: "issues",
    path: "/issues",
